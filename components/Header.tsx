...
function Header({ placeholder }: Props) {
  ...
  const isDeskop = useMediaQuery("(min-width: 475px)");
  ...
  return (
    <header className="sticky top-0 py-4 z-50 grid grid-cols-header xs:grid-cols-4 bg-white shadow-md p-2 md:px-10 ">
      {/* Left logo */}
      <div
        onClick={() => router.push("/")}
